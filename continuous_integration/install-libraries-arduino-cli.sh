...
arduino-cli --config-file arduino_cli.yaml lib install SensorModbusMaster

echo "\n\e[32mInstalling AltSoftSerial library from GitHub\e[0m"
arduino-cli --config-file arduino_cli.yaml lib install --git-url https://github.com/PaulStoffregen/AltSoftSerial.git
