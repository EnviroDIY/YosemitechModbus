...
byte modbusAddress = 0x20;  // The sensor's modbus address, or SlaveID
...
void setup()
{
    ...
    driverEnable();
    modbusSerial.write(startMeasurementW, sizeof(startMeasurementW)/sizeof(startMeasurementW[0]));
    modbusSerial.flush();
    // Print the raw send (for debugging)
    Serial.print("Raw Start Measurement Request: ");
    printFrameHex(startMeasurementW, sizeof(startMeasurementW)/sizeof(startMeasurementW[0]), &Serial);
